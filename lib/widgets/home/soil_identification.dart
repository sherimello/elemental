...
class SoilIdentification extends StatefulWidget {
  const SoilIdentification({super.key});

  @override
  State<SoilIdentification> createState() => _SoilIdentificationState();
}

class _SoilIdentificationState extends State<SoilIdentification> {
  @override
          ...
          child: Container(
            ...
            child: Center(
              child: Padding(
                ...
                child: Text("identify soil type of your land by uploading a photo", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 17),),
              ),
            ),
          ),
        ),

...
import 'package:untitled/widgets/home/bodget_formulation.dart';
import 'package:untitled/widgets/home/crop_disease_ui.dart';
import 'package:untitled/widgets/home/crop_recommendation.dart';
import 'package:untitled/widgets/home/feature_cards.dart';
import 'package:untitled/widgets/home/soil_identification.dart';
...
class _HomeState extends State<Home> {
  ...
  List<Widget> UIs = [CropRecommendation(), CropDiseaseUi(), SoilIdentification(), BodgetFormulation()];

  bool menuClicked = false;
  bool featureCardPressed = false;
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: false,
      onPopInvokedWithResult: (x,y)=>setState(() {
        featureCardPressed = false;
      }),
      child: Scaffold(
        key: _scaffoldKey,
        endDrawer: Drawer(),
        ...
        body: Stack(
          children: [
                          ...
                          child: Row(
                            children: [
                              Flexible(
                                flex: 1,
                                child: GestureDetector(
                                    onTap: featureCardPressed ? (){} : () => setState(() {
                                      i = 0;
                                      featureCardPressed = true;
                                    }),
            ...
            AnimatedPositioned(
              ...
              left: 11,
              right: 11,
              bottom: featureCardPressed ? 11 : -size.height,
              child: Container(
                width: size.width,
